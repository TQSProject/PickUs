...
public class ACPsRestControllerTests {
        ...
        public void whenPostAcpThenCreateAcp() throws Exception {
                ...
                acp.setId(1);
                Mockito.when(acpsService.save(acp)).thenReturn(acp);
                ...
                Mockito.verify(acpsService, VerificationModeFactory.times(1)).save(acp);
        ...
        public void testUpdateAcpStatus() throws Exception {
                ...
                Mockito.verify(acpsService, VerificationModeFactory.times(2)).save(Mockito.any());
        }
